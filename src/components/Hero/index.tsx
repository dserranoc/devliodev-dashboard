...
export default function Hero () {
  return (
    <header className='dark:bg-gray-900 flex flex-auto items-center'>
      <div className='py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16'>
        <div
          className='-z-10 absolute inset-0 max-w-lg m-auto h-[15rem] sm:h-72 sm:max-w-7xl' style={{
