    ...
    <header className='bg-white dark:bg-gray-900 flex flex-auto items-center'>
      <div className='py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16'>
        ...
        <div className='flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4'>
          <Link href='/signup' className='inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-devlio-purple-700 hover:bg-devlio-purple-800 focus:ring-4 focus:ring-devlio-purple-300 dark:focus:ring-devlio-purple-900'>
            Registrarse
